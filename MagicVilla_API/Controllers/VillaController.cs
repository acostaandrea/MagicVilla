...
namespace MagicVilla_API.Controllers
{
    ...
    public class VillaController : ControllerBase
    {
        ...
        [HttpGet]
        //metodo asincrono con asyn y task
        ...
        public async Task< IActionResult> DeleteVilla(int id)
        {
            ...
            //remove no es un metodo asincrono
        ...
        public async Task< IActionResult> UpdatePartialVilla(int id, JsonPatchDocument<VillaUpdateDto> patchDto)
        {
            ...
            //var villa = VillaStore.villaList.FirstOrDefault(v => v.Id == id);
            //asnotracking permite consultar un registro sin que se trackee 
            ...
            //se crea modelo luego de pasar por el patchdto, los datos son de tipo Villa y los obtenemos de villaDto
